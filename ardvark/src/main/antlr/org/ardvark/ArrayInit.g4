...
* This grammar is called ArrayInit and must
* match the filename: ArrayInit.g4
*/
grammar ArrayInit;

/**
* A rule called init that matches
...
/**
* A value can be either a nested
* array/struct or a simple integer (INT)
*/
value : init
    | INT
    ;
